...
var inspectColumns = map[string][]string{
	...
	"meta.channel_latest":       {"channel_id", "channel_type", "last_message_id", "last_message_seq", "last_at", "from_uid", "client_msg_no", "payload", "updated_at"},
	...
	"meta.user_channel_membership":    {"uid", "channel_id", "channel_type", "join_seq", "updated_at"},
	"meta.conversation":         {"uid", "channel_id", "channel_type", "read_seq", "deleted_to_seq", "active_at", "updated_at", "sparse_active"},
